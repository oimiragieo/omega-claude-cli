...
Set **`COPILOT_MODEL`** to a Copilot model string (dotted IDs — e.g. `claude-sonnet-4.6`, `gpt-5.2`). Claude Sonnet 5 is also available in Copilot CLI; run `copilot help` for the current list. PowerShell:
